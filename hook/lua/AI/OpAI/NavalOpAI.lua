...
--****************************************************************************
local CampaignOpAI = import("/lua/ai/opai/baseopai.lua").CampaignOpAI
local GenerateNavalOSB = import("/lua/ai/opai/generatenaval.lua")

---@class NavalOpAI : OpAI
NavalOpAI = Class(CampaignOpAI) {
    ---@param self AIBrain
    ---@param brain AIBrain
    ...
    Create = function(self, brain, location, name, data)
        ...
        CampaignOpAI.Create(self, brain, location, navalTable, name .. '_' .. location .. '_NavalAI', data)
