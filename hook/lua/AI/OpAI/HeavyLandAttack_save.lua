            ...
            PlatoonBuilders = {
                ...
                Builders = {
                    ['OSB_Child_HeavyLandAttack_MobileMissile'] =  {
                        ...
                        BuildConditions = {
                            {'/lua/ai/opai/heavylandattack_editorfunctions.lua', 'HeavyLandAttackChildArtillery', {'default_brain','default_master'} },
                    ...
                    ['OSB_Child_HeavyLandAttack_MediumTanks'] =  {
                        ...
                        PlatoonAIFunction = {'/lua/ScenarioPlatoonAI.lua', 'DefaultOSBasePatrol', {'default_platoon'} },
                        BuildConditions = {
                            {'/lua/ai/opai/heavylandattack_editorfunctions.lua', 'HeavyLandAttackChildDirectFire', {'default_brain','default_master'} },
                            {'/lua/editor/amplatoonhelperfunctions.lua', 'AMCheckPlatoonLock', {'default_brain','default_master'} },
                            {'/lua/editor/miscbuildconditions.lua', 'FactionIndex', {'default_brain', 1, 2} },
                        },
                        PlatoonData = {
                            {type = 5, name = 'AMPlatoons', value = {
                                {type = 2, name = 'String_0',  value = 'OSB_Master_HeavyLandAttack'},
                    ...
                    ['OSB_Child_HeavyLandAttack_MobileFlak'] =  {
                        ...
                        PlatoonAIFunction = {'/lua/ScenarioPlatoonAI.lua', 'DefaultOSBasePatrol', {'default_platoon'} },
                        BuildConditions = {
                            {'/lua/ai/opai/heavylandattack_editorfunctions.lua', 'HeavyLandAttackChildAntiAir', {'default_brain','default_master'} },
                            {'/lua/editor/amplatoonhelperfunctions.lua', 'AMCheckPlatoonLock', {'default_brain','default_master'} },
                        },
                        PlatoonData = {
                            {type = 5, name = 'AMPlatoons', value = {
                    ...
                    ['OSB_Child_HeavyLandAttack_MobileStealth'] =  {
                        ...
                        PlatoonAIFunction = {'/lua/ScenarioPlatoonAI.lua', 'DefaultOSBasePatrol', {'default_platoon'} },
                        BuildConditions = {
                            {'/lua/ai/opai/heavylandattack_editorfunctions.lua', 'HeavyLandAttackChildDefensive', {'default_brain','default_master'} },
                            {'/lua/editor/amplatoonhelperfunctions.lua', 'AMCheckPlatoonLock', {'default_brain','default_master'} },
                    ...
                    ['OSB_Master_HeavyLandAttack'] =  {
                        ...
                        BuildConditions = {
                            {'/lua/editor/amplatoonhelperfunctions.lua', 'AMCheckPlatoonLock', {'default_brain','default_master'} },
                            {'/lua/ai/opai/heavylandattack_editorfunctions.lua', 'HeavyLandAttackMasterCountDifficulty', {'default_brain','default_master'} },
                        },
